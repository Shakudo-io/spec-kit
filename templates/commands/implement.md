...
- **Legacy shorthand**: `/speckit.implement monorepo-001` - implements feature 001 in the monorepo project
- **Workspace spec ID**: `/speckit.implement monorepo:001-user-auth` - uses the rollup index to resolve the full path
