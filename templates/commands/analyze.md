...
**Constitution Authority**: The project constitution is **non-negotiable** within this analysis scope. The constitution path is provided in the `CONSTITUTION_PATH` field from the prerequisites JSON output. Constitution conflicts are automatically CRITICAL and require adjustment of the spec, plan, or tasks—not dilution, reinterpretation, or silent ignoring of the principle. If a principle itself needs to change, that must occur in a separate, explicit constitution update outside `/speckit.analyze`.
...
- Load constitution from `CONSTITUTION_PATH` (provided in prerequisites JSON) for principle validation
