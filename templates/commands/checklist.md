...
4. **Load feature context**: Read from SPEC_DIR (or FEATURE_DIR in legacy mode):
...
5. **Generate checklist** - Create "Unit Tests for Requirements":
   - Create `SPEC_DIR/checklists/` directory if it doesn't exist (or `FEATURE_DIR/checklists/` in legacy mode)
